...
### Introduction
This project implements **five Quicksort variants** and runs large-scale statistical experiments (10,000 to 50,000 elements) to compare their performance on adversarial and random inputs.
